...
//initiating empty state
const EditContact = () => {
  const [name, setName] = useState("");
  const [email, setEmail] = useState("");
  const [number, setNumber] = useState("");
  //accessing id by params
  const { id } = useParams();
  ...
  const handelSubmit = (e) => {
    ...
    //passing entered data as an object then updating it and redirecting user back to home page
    const data = {
      id: parseInt(id),
      name,
      email,
